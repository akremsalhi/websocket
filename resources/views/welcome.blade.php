...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex justify-center items-top min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="flex flex-col gap-4 m-4" id="users">
                <h1 class="text-2xl">Les utilisateurs connectés</h1>
                    ...
                    <h1 class="text-2xl">Discussion</h1>
                        ...
                        <div class="flex gap-3">
                            ...
                            <div class="relative" id="form-field">
                                ...
                                <div id="error" class="hidden text-red-800"></div>
                            </div>


                            <div class="flex justify-center items-center">
                                <button id="btn" class="bg-blue-800 px-3 py-2 text-white rounded">Envoyer</button>
                            </div>
